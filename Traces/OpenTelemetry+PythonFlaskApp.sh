...
########################################
# ⚙️ STEP 5: INSTALL FLASK + OPENTELEMETRY PACKAGES
########################################
...
########################################
# 🧩 STEP 6: CREATE FLASK APP (app.py)
########################################
...
# ⚠️ Replace <Tempo-Private-IP> with your Tempo server's PRIVATE IP (not public)
# ------------------------
...
echo "Traces will be sent to: http://<Tempo-Private-IP>:4318/v1/traces"
echo "=============================================================="
